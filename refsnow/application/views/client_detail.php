<section class="client-profile-page1" id="main-container">
        ...
        <div id="content_left">
            <img class="client_login_image" src="<?php echo base_url(); ?>theme/images/iStock_000002477442Large-min.jpg"/>
            <img class="client_login_image" src="<?php echo base_url(); ?>theme/images/z - stock-photo-24508071-sexy-woman-lying-on-bed-using-cell-phone-min.jpg" />
            <img class="client_login_image" src="<?php echo base_url(); ?>theme/images/z - stock-photo-28972460-woman-in-bed-with-laptop-min.jpg"/>
            <img class="client_login_image" src="<?php echo base_url(); ?>theme/images/z - stock-photo-8311372-working-at-home-min.jpg"/>
        </div>
       ...
       <div id="content_right">
         <section  class="form_container">
             ...
             <form enctype="multipart/form-data"  name="client_profile_form" id="client_profile_form" method="post">
                ...
                <div class="form_title"> <h1>Client Detail Profile</h1></div> 
                <div class="separator separator_provider_signup"></div>
                
                <div class="post-reviw-column3">
                    <div class="post_review_column_inner"> 
                        <label for="client_first_name" class="normal_text_label"># of reviews <?php echo $client_reviews; ?></label><br><br>                         
                    </div>
                </div>
                
                <div class="post-reviw-column3">
                    <div class="post_review_column_inner"> 
                        <label for="client_first_name" class="normal_text_label">Your membership expired, So please update your membership. </label><br><br>                         
                    </div>
                </div>
                 <?php 
                
                if($provider_membership->status=='deactive')
                {
                    ?>
                    <div class="post-reviw-column3">
                            <div class="post_review_column_inner">
                                <a href="<?php echo base_url(); ?>subscription/payment" class="submit_button_uni">Update subscription</a>
                            </div>
                    </div>
                    <?php                 
                } 
                
                if($provider_membership->status=='active')
                {
                    ?>
                    <div class="post-reviw-column3">
                        <div class="post_review_column_inner"> 
                ...
                <div class="post-reviw-column3">
                     <div class="post_review_column_inner">
                        ...
                        <input type="text" placeholder="Height" class="date_of_meeting" value="<?php echo set_value('client_age',$client->client_age); ?>" name="client_age" id="client_age" />
                ...
                <div class="post-reviw-column3">
                 ...
                 <div class="post-reviw-column3">
                     <div class="post_review_column_inner">
                        <span class="normal_text_label">Profile Image </span><br> 
                        <img style="border:1px solid #d9394d;" width="80" height="80" src="<?php echo base_url(); ?>uploads/clients/profile/<?php echo $client->client_profile_pic.$client->client_pic_ext; ?>" />

    ...
    <div class="content-container">
        ...
        <div class="row_title">
            <ul class="row_title_heading">
                <li class="review_f_name">Review Order</li>
                ...
                <li class="review_related"> View Detail</li>
            </ul>
        </div>
        <?php if(isset($your_reviews) && !empty($your_reviews))
            ...
            <div class="row_data">
               <ul class="row_data_detail">
                    <li class="review_f_name"><?php echo $i ?> Review</li>
                    ...
                    <li class="review_related"><a href="<?php echo base_url().'reviews/review_detail/'.encodeWithCodeigniter($value->review_id); ?>">View</a></li>
               </ul>
           </div>
        <?php
           }
        }else { ?>
         <div class="row_data"> No record found.</div>
        <?php }  ?>
